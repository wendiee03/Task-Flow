...
app.use(express.static(path.join(__dirname, '../client/task-management-app/build')));
...
app.get('*', (req, res) => {
    res.sendFile(path.join(__dirname + '/../client/task-management-app/build/index.html'));
});
